...
export const PistolsArray = [
    { id: 1, name: 'Glock', description: 'lorem asdsad asd asd asdjnda jn jans kjsand kjasn jaksn sadn jk lorem asdsad asd asd asdjnda jn jans kjsand kjasn jaksn sadn jk', img: 'src' },
